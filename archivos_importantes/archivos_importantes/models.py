...
class Calendar(db.Model):
    __tablename__ = dbtableprefix + "calendar"
    id = db.Column(db.Integer(), primary_key=True)
    date =  db.Column(db.DateTime())
    year = db.Column(db.Integer())
    month = db.Column(db.Integer())
    day = db.Column(db.Integer())
    month_name = db.Column(db.Text())
    day_name = db.Column(db.Text())
    day_number = db.Column(db.Integer())
    week_year = db.Column(db.Integer())
    semester = db.Column(db.Integer())
    trimester = db.Column(db.Integer())
    quarter = db.Column(db.Integer())
    enable = db.Column(db.Integer())

class DniGroups(db.Model):
    __tablename__ = dbtableprefix + "dnigroups"
    id = db.Column(db.Integer(), primary_key=True)
    code = db.Column(db.Text())

class DniTypess(db.Model):
    __tablename__ = dbtableprefix + "dnitypes"
    id = db.Column(db.Integer(), primary_key=True)
    code = db.Column(db.Text())
...
class DniTypeGroup(db.Model):
    __tablename__ = dbtableprefix + "dnitypegroup"
    typedni = db.Column(db.Integer(), primary_key=True)
    groupdni = db.Column(db.Integer(), primary_key=True)

class Cities(db.Model):
    __tablename__ = dbtableprefix + "cities"
    id = db.Column(db.Integer(), primary_key=True)
    name = db.Column(db.Text())
